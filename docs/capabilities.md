...
Those are Grok Build capabilities. `pi-grok-build` adopts a capability when this repo adds the corresponding source contract, implementation, tests, and proof lane.
